...
# ==============================================================================
# 1. High-Density Multi-Step Reasoning Dataset Generation
# ==============================================================================

def generate_hybrid_training_data(num_samples=1000):
    ...
    # 2. Probability Reasoning (1000 samples)
    for _ in range(num_samples):
...
# ==============================================================================
# 2. Packed Dataset Builder
# ==============================================================================

class HybridMasterDataset(Dataset):
    def __init__(self, raw_guanaco, synthetic_examples, tokenizer, seq_len=256, max_blocks=6000):
        self.examples = []
        all_tokens = []
        
        print("Packing synthetic math/logic/coding dataset...")
...
def run_hybrid_master_calibration():
    model_id = "google/gemma-3-1b-it"
    weights_path = "gemma3_eml_kan/model_state.pt"
    save_tuned_path = "gemma3_eml_kan/model_state_master_hybrid.pt"
    
    print("Loading tokenizer...")
    tokenizer = AutoTokenizer.from_pretrained(model_id)
    
    print("Generating synthetic datasets...")
    synthetic_examples = generate_hybrid_training_data(num_samples=1000)
    
    print("Loading raw openassistant-guanaco dataset...")
    raw_guanaco = load_dataset("timdettmers/openassistant-guanaco", split="train")

    train_dataset = HybridMasterDataset(raw_guanaco, synthetic_examples, tokenizer, seq_len=256, max_blocks=8000)
    ...
    print(f"Starting Hybrid Master Calibration training for {max_steps} steps...")
    t_start = time.time()
    ...
    print(f"Saving hybrid master calibrated weights to {save_tuned_path}...")
