...
def main():
    ...
    save_path = "gemma3_eml_kan/model_state_zero_error.pt"
    device = "cuda:0"
    ...
    print(f"Saving zero-error model state dict to {save_path}...")
    os.makedirs(os.path.dirname(save_path), exist_ok=True)
    torch.save(model.state_dict(), save_path)
    
    print("\nRunning evaluation to verify saved weights...")
    ...
    print("\n" + "="*80)
    print("                      ZERO-ERROR EML-KAN HYBRID VERIFICATION RESPONSE")
    print("="*80)
    print(response)
    print("="*80)
