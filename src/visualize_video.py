...
def generate_video_visualization(checkpoint_path, data_path, output_path="viz/final_trajectory.mp4"):
    ...
    for angle in range(0, 360, 10): # Faster generation
        ...
        ax.plot(tx, ty, tz, 'b--x', label='Target', markersize=4)
        ax.scatter(px[0], py[0], pz[0], color='green', s=100)
...
if __name__ == "__main__":
    generate_video_visualization(
        "/home/jupyter-238w1a5447/robotmodel/robotmodel/models/checkpoints/latest.pt",
        "/home/jupyter-238w1a5447/robotmodel/data/processed_bridge.parquet",
        "viz/real_trajectory.mp4"
    )
